...
def jpegenc_dwt(X: np.ndarray, n, k, step_multiplier, rise_ratio, 
    ...
    '''
    step_ratios= make_freq_weighted_step_ratios(n, k)
...
def jpegdec_dwt(vlc: np.ndarray, n, k, step_multiplier, rise_ratio, 
